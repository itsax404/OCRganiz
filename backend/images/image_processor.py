...
from .reconnaisseurs.adresse_reconnaisseur import Adresse_Reconnaisseur
from .reconnaisseurs.entreprise_reconnaisseur import Entreprise_Reconnaisseur
from .reconnaisseurs.personnee_reconnaisseur import Personne_Reconnaisseur
...
class Image_Processor:
    ...
    def reconnaitre(self, image, coordonnees, objet):
        ...
        if objet is None:
            ...
            for coordonnée in coordonnées:
                type_donnee = coordonnée["type"]
                ...
                if len(sous_parties) == 1:
                    ...
                    if (sous_parties[0] == "adresse") and (type(objet) == Adresse):
                        ...
                        match sous_partie[1]:
                            ...
                            case "adresse":
                                self.adresse_reconnaisseur.reconnaitre(self.__crop_and_ocr__(coordonnee["coordonnées"]))
                                return self.adresse_reconnaisseur.avoir()
                    elif (sous_partie[0] == "personne") and (type(objet) == Entreprise):
                        personne = objet
                        match sous_partie[1]:
                            case "nom":
                                self.entreprise_reconnaisseur.reconnaitre(coordonnee["coordonnees"])
                    ...
                    if(parties[0] != "entreprise") or (parties[1] != "adresse"):
