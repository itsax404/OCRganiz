...
class Fiche_Paie:
	...
	def __init__(self, entreprise: Entreprise, employé: Personne, date: str, revenu_brut: float, revenu_net: float,
	             fichier: bytes = None, nom_fichier: str = None, id: int = -1) -> None:
		"""
	...
	def __eq__(self, other: object) -> bool:
        ...
        :rtype: bool
        """
		return (self.entreprise == other.entreprise) and (self.employé == other.employé) and (
				self.date == other.date) and (self.revenu_brut == other.revenu_brut) and (
				self.revenu_net == other.revenu_net)
